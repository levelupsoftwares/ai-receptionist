INTENTS = {
    ...
    "acknowledgement":["ok","okay","kk","k","alright","all right","sure","fine","cool","great","nice","perfect","understood","got it","i got it","i understand","understand","makes sense","sounds good""that works","works for me","yes","yeah","yep","yup","ya","yah","correct","right","exactly","true","indeed","absolutely","definitely","certainly",],
